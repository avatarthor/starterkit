					...
					<div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
						...
						<div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../demo8/dist/index.html" action="#">
								...
								<a href="../../demo8/dist/authentication/layouts/creative/sign-up.html" class="link-primary">Sign up</a></div>
								<!--end::Sign up-->
							</form>
							<!--end::Form-->
						</div>
						...
						<div class="d-flex flex-stack px-lg-10">
							...
							<div class="d-flex fw-semibold text-primary fs-base gap-5">
								...
								<a href="../../demo8/dist/pages/pricing/column.html" target="_blank">Plans</a>
